...
import { Button, ToastAndroid, input, Block, Text, Toast, theme, withGalio, GalioProvider } from "galio-framework";
...
export default function App() {
  ...
  useEffect(() => {
    db.transaction((tx) => {
      tx.executeSql(
        //V1
        "create table if not exist items" + "(id integer primary key not null, done int, value text);"
    ...
    <View style={styles.container}>
      ...
      {Platform.OS === "web" ? (
        ...
        <>
          ...
          <Toast isShow={isShow} color="warning" positionIndicator="top"> Notificação no Topo</Toast>
